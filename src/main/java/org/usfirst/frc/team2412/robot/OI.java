...
public class OI {
	...
	public OI() {
		cargo1.whenPressed(new LiftSetInchCommand(LiftHeights.CARGO1, 1));
		cargo2.whenPressed(new LiftSetInchCommand(LiftHeights.CARGO2, 1));
		cargo3.whenPressed(new LiftSetInchCommand(LiftHeights.CARGO3, 1));

		hatch1.whenPressed(new LiftSetInchCommand(LiftHeights.HATCH1, 1));
		hatch2.whenPressed(new LiftSetInchCommand(LiftHeights.HATCH2, 1));
		hatch3.whenPressed(new LiftSetInchCommand(LiftHeights.HATCH3, 1));
	}
